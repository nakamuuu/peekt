...
data class HttpTransactionEntity(
    ...
    @ColumnInfo(name = "request_body_bytes") val requestBodyBytes: ByteArray? = null,
    @ColumnInfo(name = "request_content_type") val requestContentType: String? = null,
    @ColumnInfo(name = "request_body_size") val requestBodySize: Long? = null,
    @ColumnInfo(name = "request_body_kind") val requestBodyKind: String? = null,
    @ColumnInfo(name = "response_body") val responseBody: String?,
    @ColumnInfo(name = "response_body_bytes") val responseBodyBytes: ByteArray? = null,
    @ColumnInfo(name = "response_content_type") val responseContentType: String? = null,
    @ColumnInfo(name = "response_body_size") val responseBodySize: Long? = null,
    @ColumnInfo(name = "response_body_kind") val responseBodyKind: String? = null,
